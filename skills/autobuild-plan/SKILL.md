...
5. **Queue:** give each item its scope source, change notes, lane, dependencies and testable acceptance criteria. Cover build, go-live preparation, blocked production deployment, publication updates, and blocked publication. State the park path for any item that needs a person or production access during its cycle.
